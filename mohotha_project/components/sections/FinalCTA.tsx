    ...
    <section className="relative overflow-hidden py-32 lg:py-48 bg-[#050505] border-t border-[#111111]">
      ...
      <div className="absolute inset-0 z-0 pointer-events-none overflow-hidden flex items-center justify-center">
        <motion.div 
          ...
          className="w-[800px] h-[800px] rounded-full border border-[#222222]" 
        />
        <motion.div 
          initial={{ scale: 0.8, opacity: 0 }}
          ...
          className="absolute w-[600px] h-[600px] rounded-full border border-[#222222]" 
        />
        <motion.div 
          initial={{ scale: 0.8, opacity: 0 }}
          ...
          className="absolute w-[400px] h-[400px] bg-[radial-gradient(ellipse_at_center,rgba(203,163,101,0.03)_0%,rgba(5,5,5,0)_70%)] blur-2xl" 
        />
      </div>
      ...
      >
        ...
        <motion.p variants={itemVariants} className="mb-6 text-[10px] font-medium uppercase tracking-[0.4em] text-[#CBA365]">
          The Beginning
        </motion.p>
        
        <motion.h2 variants={itemVariants} className="heading-font text-5xl md:text-6xl font-normal leading-tight text-white lg:text-7xl">
          Curate Your <span className="text-[#CBA365] italic">Legacy</span>
        </motion.h2>
        
        <motion.p variants={itemVariants} className="mx-auto mt-8 max-w-lg text-sm leading-relaxed text-[#a3a3a3] font-light">
